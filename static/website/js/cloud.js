$(document).ready(function() {
    ...
    */
	...
	Dajaxice.website.change_ct(function(data) { 
	...
	Dajaxice.website.change_bk(function(data) { 
	...
	Dajaxice.website.change_ch(function(data) { 
    ...
    $(document).on("change", "#examples", function() {
       ...
       Dajaxice.website.get_example(function(data) {
  ...
  Dajaxice.website.bug_form(function(data){
    ...
    $(document).on("click", "#bug-form-submit", function(e){
        ...
        Dajaxice.website.email_one(function(data){
            Dajax.process(data);
        });	        
	e.preventDefault();
    });

   $(document).on("load", "#bug-form", function() {

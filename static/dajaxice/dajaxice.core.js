...
var Dajaxice = {
    ...
    email_one: function(callback_function, argv, custom_settings){
        return Dajaxice.call('website.forms.email_one', 'POST', callback_function, argv, custom_settings);
    },
    ...
    get_example: function(callback_function, argv, custom_settings){
        return Dajaxice.call('website.forms.codes', 'POST', callback_function, argv, custom_settings);
    },
    change_ch: function(callback_function, argv, custom_settings){
        return Dajaxice.call('website.forms.change_ch', 'POST', callback_function, argv, custom_settings);
    },
    change_ct: function(callback_function, argv, custom_settings){
        return Dajaxice.call('website.forms.change_ct', 'POST', callback_function, argv, custom_settings);
    },   
    change_bk: function(callback_function, argv, custom_settings){
        return Dajaxice.call('website.forms.change_bk', 'POST', callback_function, argv, custom_settings);
    },
